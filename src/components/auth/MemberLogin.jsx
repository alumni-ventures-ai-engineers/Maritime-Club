    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: 'var(--primary-color, #1B4D5C)' }}>
      <Card className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Welcome to the<br />Maritime</h1>
          <p className="text-gray-500 mt-1">Invest in the Infrastructure Powering Global Trade</p>
        </div>
